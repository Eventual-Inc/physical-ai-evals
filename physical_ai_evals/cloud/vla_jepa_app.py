...
Run::
    ...
    modal run physical_ai_evals/cloud/vla_jepa_app.py --smoke-test
    modal run physical_ai_evals/cloud/vla_jepa_app.py --download-only
    modal run physical_ai_evals/cloud/vla_jepa_app.py --suites libero_spatial --task-ids 0 --episodes 2
"""
