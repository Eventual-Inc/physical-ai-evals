...
- [Daft](https://github.com/Eventual-Inc/Daft), robosuite, MuJoCo, Modal, PyTorch, and other
...
Those terms can differ across code repositories, checkpoints, datasets, and assets and can
change independently of this project.

Installed Python and system packages carry their own license metadata and notices. This file is
a scope clarification, not an exhaustive dependency bill of materials or legal advice.
